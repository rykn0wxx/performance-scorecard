...
export const initAwsomeRouter = (props: any, context: any) => {
  ...
  function extractChildrenRoutes(obj: any, keyToFind: any): any {
    if (!obj) return
    return Object.entries(obj).reduce((acc: any, [key, value]: any) => (key === keyToFind ? acc.concat(value) : typeof value === 'object' ? acc.concat(extractChildrenRoutes(value, keyToFind)) : acc), [])
  }
